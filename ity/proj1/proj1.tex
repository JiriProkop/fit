...
\author{Jiří Prokop \\ \href{mailto:xproko47@fit.vutbr.cz}{xproko47@fit.vutbr.cz}}
\date{}
...
\begin{quotation}
Čím více \texttt{druhů}, \emph{řezů}, {\tiny velikostí}, {\color{green} barev} písma\\
a \textsc{\color{blue} jiných efektů} \underline{použijeme}, {\color{red} tím profesionál\-něji} bude 
{\fontfamily{pzc}\selectfont dokument} vypadat. Čtenář tím bude \textbf{\fontsize{27pt}{0pt} \selectfont vždy nadšen!}
\end{quotation}

\textsc{Tímto pravidlem se \underline{nesmíte nikdy řídit.}} Příliš
časté zvýrazňování textových elementů a změny {\footnotesize velikosti} 
písma jsou známkou \textbf{amatérismu autora} a působí {\fontfamily{cmtt}\selectfont velmi
...
\begin{itemize}
    ...
    \item Nadpisy, číslování a odkazy na číslované elementy musí být sázeny příkazy k tomu určenými. Číslování sekcí tohoto dokumentu je zajištěno příkazem
    \verb|\section|.
...
uvozovky typu\,\uv{9966}\,místo ‘‘anglických uvozovek’’. Lze je
...
\uv{a} končit může pouze při sazbě do šířky 25 liter. Abychom \LaTeX u zabránili v sázení osamocených předložek, spojujeme je s následujícím slovem \emph{nezlomitelnou mezerou}. Tu
sázíme pomocí znaku \textasciitilde \ (vlnka, tilda). 
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana
Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{http://petr.olsak.net/ftp/olsak/vlna/}  }, který je vhodné si v rámci projektu vyzkoušet.

Balíček {\fontfamily{cmtt}\selectfont fontenc} slouží ke korektnímu kódovaní znaků\\
