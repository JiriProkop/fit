...
\usepackage[a4paper,left=1.5cm,text={18cm, 24.5cm},top=2cm]{geometry}
...
\author{Štěpán Czajkowski \\ \href{mailto:xczajk01@stud.fit.vutbr.cz}{xczajk01@stud.fit.vutbr.cz}}
\date{\vspace{-4ex}}
...
\begin{adjustwidth}{0.7cm}{0.7cm}
    \quad Čím více \emph{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue}{barev}  písma a jiných \textcolor{red}{\textsc{efektů}} \underline{použijeme}, tím {\color{orange}profesionálněji} bude {\fontfamily{pzc}\selectfont \Large dokument} vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
\end{adjustwidth}
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnotemark, který si můžete v rámci projektu vyzkoušet.
